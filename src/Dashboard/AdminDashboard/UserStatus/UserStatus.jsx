...
const UserStatus = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2  gap-4 px-4 mt-8  lg:grid-cols-4 mb-10 sm:px-8">
        ...
        <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
            ...
            <div className="px-4 text-gray-700">
                <h3 className="text-sm tracking-wider">Avail-able pet</h3>
        ...
        <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
            ...
            <div className="px-4 text-gray-700">
                <h3 className="text-sm tracking-wider">Running Campaign</h3>
        ...
        <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
            ...
            <div className="px-4 text-gray-700">
                <h3 className="text-sm tracking-wider">Donated money</h3>
