...
const Campaign = () => {
  ...
  <div className="mt-3 text-center text-4xl font-bold">Make an Campaign</div>
  <div className="p-8">
    ...
    <div className="text-center">
      <a className="cursor-pointer rounded-lg bg-blue-700 px-8 py-5 text-sm font-semibold text-white">Create an Campaign</a>
    </div>
  </div>
</div>
    );
